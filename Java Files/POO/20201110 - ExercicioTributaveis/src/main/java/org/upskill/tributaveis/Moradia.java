...
//    private static int fatorImposto = 2;
    private static double fatorImposto = 2;
    ...
    public double calcularImposto() {
        return getArea() * getFatorImposto();
    }

    /**
     * @return the fatorImposto
     */
    public static double getFatorImposto() {
        return fatorImposto;
    }

    /**
     * @param aFatorImposto the fatorImposto to set
     */
    public static void setFatorImposto(double aFatorImposto) {
        fatorImposto = aFatorImposto;
    }
}