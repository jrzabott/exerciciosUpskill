...
import upskill.AutarquiaWS.exception.NumeroFuncionarioInvalidoException;
...
public class Funcionario extends Pessoa implements Serializable {
    ...
    public void setNumeroFuncionario(int numeroFuncionario) throws NumeroFuncionarioInvalidoException {
        if (numeroFuncionario > 0) {
            ...
            throw new NumeroFuncionarioInvalidoException(numeroFuncionario + ": Número inválido");
        }
    }
