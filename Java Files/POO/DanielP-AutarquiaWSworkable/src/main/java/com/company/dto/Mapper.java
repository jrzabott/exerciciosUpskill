...
//does nothing. Actually, nothing is added to arraylist
    ...
    public static FreguesiaDTO freguesia2PFreguesiaDTO(Freguesia f) throws NullPointerException {
        FreguesiaDTO freguesiaDTO = new FreguesiaDTO();
        freguesiaDTO.setNome(f.getNome());
        return freguesiaDTO;
    }

    public static Freguesia freguesiaDTO2Freguesia(FreguesiaDTO fDTO) throws NullPointerException {
        Freguesia f = null;
        f = new Freguesia(fDTO.getNome());
        return f;
    }
    ...
    public static ListaFreguesiaDTO listFreguesia2FreguesiaDTO(ArrayList<Freguesia> freguesias) throws NullPointerException {
        ...
        for (Freguesia freguesia : freguesias) {
            try {
                FreguesiaDTO freguesiaDTO = freguesia2PFreguesiaDTO(freguesia);
